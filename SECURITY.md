...
If you discover a security vulnerability within VeloProve, please report it privately via **GitHub Private Vulnerability Reporting** (under the repository's Security tab) instead of opening a public issue.

## Local-First Security & Privacy Principles

VeloProve is designed with local-first security:
