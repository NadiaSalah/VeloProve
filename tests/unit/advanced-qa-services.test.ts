...
describe('Advanced QA Services (Security Audit, Perf Profiler, MSW Mock Generator, Flaky Quarantine, Coverage Heatmap)', () => {
  const fixtureDir = path.resolve(process.cwd(), 'fixtures/advanced-qa-fixture');
