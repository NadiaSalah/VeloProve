 ...
 * Dashboard is a curated subset — missing dashboardAction is allowed but reported.
 */
export const TOOL_SURFACE: ToolSurfaceEntry[] = [
  ...
  { id: 'refine', cli: 'refine', mcp: 'vp.refine', docMarkers: ['`vp.refine`', '`veloprove refine`'], tier: 'needs-state', summary: 'NL refine of assertions' },
  { id: 'a11y', cli: 'a11y', mcp: 'vp.accessibility', dashboardAction: 'a11y', docMarkers: ['`vp.accessibility`', '`veloprove a11y`'], uiGuideMarker: 'A11y', tier: 'offline', summary: 'WCAG accessibility audit' },
  ...
  { id: 'suggestFix', mcp: 'vp.suggestFix', docMarkers: ['`vp.suggestFix`'], tier: 'needs-state', summary: 'App bug fix suggestions (MCP-only)' },
  ...
  { id: 'run-collection', cli: 'run-collection', mcp: 'vp.runCollection', docMarkers: ['`vp.runCollection`', '`veloprove run-collection`'], tier: 'needs-url', summary: 'Run Postman collections' },
  ...
  { id: 'request', cli: 'request', mcp: 'vp.sendRequest', docMarkers: ['`vp.sendRequest`', '`veloprove request`'], tier: 'needs-url', summary: 'Ad-hoc HTTP request' },
  { id: 'load-test', cli: 'load-test', mcp: 'vp.loadTest', docMarkers: ['`vp.loadTest`', '`veloprove load-test`'], uiGuideMarker: 'Load', tier: 'needs-url', summary: 'Local load/stress test' },
  { id: 'mock-data', cli: 'mock-data', mcp: 'vp.mockData', docMarkers: ['`vp.mockData`', '`veloprove mock-data`'], tier: 'offline', summary: 'AI mock data factory' },
  { id: 'owasp-scan', cli: 'owasp-scan', mcp: 'vp.owaspScan', docMarkers: ['`vp.owaspScan`', '`veloprove owasp-scan`'], tier: 'needs-url', summary: 'OWASP header/security scan' },
  { id: 'graphql', cli: 'graphql', mcp: 'vp.graphqlTest', docMarkers: ['`vp.graphqlTest`', '`veloprove graphql`'], tier: 'needs-url', summary: 'GraphQL query test' },
  { id: 'ws-test', cli: 'ws-test', mcp: 'vp.wsTest', docMarkers: ['`vp.wsTest`', '`veloprove ws-test`'], tier: 'needs-url', summary: 'WebSocket handshake test' },
  { id: 'remote-init', cli: 'remote-init', mcp: 'vp.remoteInit', docMarkers: ['`vp.remoteInit`', '`veloprove remote-init`'], tier: 'offline', summary: 'Generate remote probe' },
  { id: 'remote-connect', cli: 'remote-connect', mcp: 'vp.remoteConnect', docMarkers: ['`vp.remoteConnect`', '`veloprove remote-connect`'], tier: 'needs-url', summary: 'Connect remote probe' },
  { id: 'remote-audit', cli: 'remote-audit', mcp: 'vp.remoteAudit', docMarkers: ['`vp.remoteAudit`', '`veloprove remote-audit`'], tier: 'needs-url', summary: 'Live remote QA audit' },
  ...
  { id: 'stabilize', cli: 'stabilize', mcp: 'vp.stabilizeFlaky', docMarkers: ['`vp.stabilizeFlaky`', '`veloprove stabilize`'], tier: 'needs-state', summary: 'Stabilize flaky tests' },
  { id: 'db-snapshot', cli: 'db-snapshot', mcp: 'vp.dbSnapshot', docMarkers: ['`vp.dbSnapshot`', '`veloprove db-snapshot`'], tier: 'offline', summary: 'DB/fixture snapshot' },
  { id: 'db-restore', cli: 'db-restore', mcp: 'vp.dbRestore', docMarkers: ['`vp.dbRestore`', '`veloprove db-restore`'], tier: 'needs-state', summary: 'Restore DB snapshot' },
  { id: 'auto-fix', cli: 'auto-fix', mcp: 'vp.autoBugFix', dashboardAction: 'auto-fix', docMarkers: ['`vp.autoBugFix`', '`veloprove auto-fix`'], uiGuideMarker: 'Auto-Fix', tier: 'destructive', summary: 'Synthesize app bug fixes' },
  ...
  { id: 'chaos', cli: 'chaos', mcp: 'vp.chaosTest', docMarkers: ['`vp.chaosTest`', '`veloprove chaos`'], tier: 'needs-url', summary: 'Chaos monkey probes' },
  ...
  { id: 'alert', cli: 'alert', mcp: 'vp.sendAlert', docMarkers: ['`vp.sendAlert`', '`veloprove alert`'], tier: 'needs-url', summary: 'Webhook alerts' },
  ...
  { id: 'screen-reader', cli: 'screen-reader', mcp: 'vp.screenReaderSim', dashboardAction: 'screen-reader', docMarkers: ['`vp.screenReaderSim`', '`veloprove screen-reader`'], uiGuideMarker: 'Screen Reader', tier: 'offline', summary: 'Screen reader flow sim' },
  ...
  { id: 'rate-limit', cli: 'rate-limit', mcp: 'vp.rateLimitAudit', docMarkers: ['`vp.rateLimitAudit`', '`veloprove rate-limit`'], tier: 'needs-url', summary: 'Rate-limit/DoS profile' },
  { id: 'mock-server', cli: 'mock-server', mcp: 'vp.statefulMock', docMarkers: ['`vp.statefulMock`', '`veloprove mock-server`'], tier: 'interactive', summary: 'Stateful mock REST server' },
  ...
  { id: 'init', cli: 'init', docMarkers: ['`veloprove init`'], tier: 'offline', summary: 'Initialize project config' },
  { id: 'ui', cli: 'ui', docMarkers: ['`veloprove ui`'], uiGuideMarker: 'dashboard', tier: 'interactive', summary: 'Live HTML dashboard' },
  { id: 'tui', cli: 'tui', docMarkers: ['`veloprove tui`'], tier: 'interactive', summary: 'Terminal command center' },
  { id: 'setup-ci', cli: 'setup-ci', docMarkers: ['`veloprove setup-ci`'], tier: 'offline', summary: 'Generate CI quality gate' },
  { id: 'sandbox', cli: 'sandbox', docMarkers: ['`veloprove sandbox`'], tier: 'offline', summary: 'Isolated sandbox runner' },
  { id: 'watch', cli: 'watch', docMarkers: ['`veloprove watch`'], tier: 'interactive', summary: 'Watch mode test runner' },
  { id: 'hook', cli: 'hook', docMarkers: ['`veloprove hook`'], uiGuideMarker: 'hook', tier: 'offline', summary: 'Git pre-commit hook' },
  { id: 'mcp', cli: 'mcp', docMarkers: ['`veloprove mcp`'], uiGuideMarker: 'mcp', tier: 'interactive', summary: 'Start MCP stdio server' }
];
